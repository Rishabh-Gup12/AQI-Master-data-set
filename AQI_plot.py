...
# def avg_data_year(years):
#     temp_i=0
#     average=[]
#     for rows in pd.read_csv('Data/AQI/aqi{}.csv'.format(years),chunksize=24):
#         add_var=0
#         avg=0
#         data=[]
...
# # avg_data_year(2013) 
# # avg_data_year(2013).count

# # lst2013=avg_data_year(2018) 
# # print(lst2013)
# # a=np.array(lst2013)
# # print(a.shape)
...
#     plt.plot(range(0,365),lst2017,label="2014 data")
